                        ...
                        <div class="container-fluid">
                            <div class="row">
                                <div class="col-12 pt-5">
                                    <a class="btn btn-primary" href="add_lesson_notes.php"><i class="ti-back-left mr-2"></i>Back to Add Lesson Notes</a>
                            ...
                            <div class="col-12 mt-2 grid-margin">
                                <div class="card">
                                    <div class="card-body">
                                        <h4 class="card-title">Add New Lesson Notes</h4>
                                        <p class="text-dark">
                                            You can add new lesson Notes to the portal and you can update or remove them using the previous page
                                        </p>
                                        <div class="form-sample">
                                            ...
                                            <p class="card-description">
                                                Add small description about Lesson Note
                                            </p>
                                            <div class="row">
                                                <div class="col-md-12">
                                                    <div class="form-group row">
                                                        <label class="col-sm-3 col-form-label">Lesson Note Description</label>
                                                        <div class="col-sm-9">
                                            ...
                                            <div class="row">
                                                <div class="col-md-6">
                                                    <div class="form-group row">
                                                        <label class="col-sm-3 col-form-label">Lesson Note</label>
                                                        <div class="col-sm-9">
                                            ...
                                            <div class="row">
                                                <div class="col-6 mt-4 offset-3">
                                                    <button class="btn btn-inverse-primary col-12" onclick="new_lesson_notes()">Add Lesson Note</button>
                                                </div>
                                            </div>
