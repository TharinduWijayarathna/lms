    ...
    if (empty($fname)) {
        ...
        if ($rs->num_rows == 0) {
            ...
            if (!$mail->send()) {
                ...
                Database::iud("INSERT INTO `teachers`(`username`,`first_name`,`last_name`,`email`,`gender_id`,`password`,`verification_code`,`registered_on`,`status_id`,`verification_id`) VALUES ('" . $username . "','" . $fname . "','" . $lname . "','" . $email . "','" . $gender_id . "','" . $password . "','" . $verification_code . "','" . $date . "','" . $status . "','" . $verify_id . "'); ");
