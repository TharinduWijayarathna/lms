      ...
      <nav class="navbar col-lg-12 col-12 p-0 fixed-top d-flex flex-row">
        ...
        <div class="navbar-menu-wrapper d-flex align-items-center justify-content-end">
          ...
          <ul class="navbar-nav navbar-nav-right">
            ...
            if ($_SESSION["t"]["verification_id"] == 1) {
            ?>
            ...
            <li class="nav-item nav-profile dropdown">
              <a class="nav-link dropdown-toggle" href="#" data-toggle="dropdown" id="profileDropdown">
                <?php
                //search details from teachers img table
                $imgfind = Database::search("SELECT * FROM `teacher_img` WHERE `teachers_id` = '" . $_SESSION["t"]["id"] . "'");
                ...
                ?>
                  <img src="images/teacher_profile/<?php echo $idata["path"] ?>" alt="profile">
                <?php
                } else {
                ?>
              ...
              <div class="dropdown-menu dropdown-menu-right navbar-dropdown" aria-labelledby="profileDropdown">
                <a class="dropdown-item" href="update_teachers_profile.php">
      ...
      <div class="container-fluid page-body-wrapper">
        ...
        <nav class="sidebar sidebar-offcanvas" id="sidebar">
          <ul class="nav">
            ...
            <li class="nav-item">
              <a class="nav-link" href="add_lesson_notes.php">
                <i class="icon-circle-plus menu-icon"></i>
                <span class="menu-title">Add lesson notes</span>
              </a>
            </li>
            <li class="nav-item">
              <a class="nav-link" href="add_new_assignments.php">
                <i class="icon-square-plus menu-icon"></i>
                <span class="menu-title">Add new assignments</span>
              </a>
            </li>
            <li class="nav-item">
              <a class="nav-link" href="view_submitted_answer_sheets.php">
                <i class="icon-archive menu-icon"></i>
                <span class="menu-title">View submitted <br>
                  answer sheets</span>
              </a>
            </li>
            <li class="nav-item">
              <a class="nav-link" href="add_assignment_marks.php">
                <i class="icon-upload menu-icon"></i>
                <span class="menu-title">Add assignment marks</span>
              </a>
            </li>
          ...
          <div class="content-wrapper">
              ...
              <div class="col-md-12 grid-margin">
                <div class="row">
                  <div class="col-12 col-xl-8 mb-4 mb-xl-0">
                    <h3 class="font-weight-bold">Welcome <?php echo $_SESSION["t"]["first_name"] . " " . $_SESSION["t"]["last_name"] ?></h3>
                    <h6 class="font-weight-normal mb-0">
                      You can work with assigned grades and subjects !
            ...
            <div class="row">
              ...
              <div class="col-md-12 grid-margin transparent">
                <div class="row">
                  <?php
                  //get row count from added assignment table
                  $assignments = Database::search("SELECT * FROM `added_assignment` WHERE `teachers_id` = '" . $_SESSION["t"]["id"] . "'");
                  $asn = $assignments->num_rows;

                  //get row count from lesson notes table
                  $lessons = Database::search("SELECT * FROM `lesson_notes` WHERE `teachers_id` = '" . $_SESSION["t"]["id"] . "'");
                  $lsn = $lessons->num_rows;

                  //get row count from assigned subject table
                  $subcount = Database::search("SELECT * FROM `assigned_subject` WHERE `teachers_id` = '" . $_SESSION["t"]["id"] . "'");
                  $sc = $subcount->num_rows;
                  ?>
                  ...
                  <div class="col-md-4 mb-5 stretch-card transparent">
                    <div class="card bg-gradient-danger">
                      <div class="card-body">
                        <p class="mb-4 font-weight-bolder">Added Assignments</p>
                  ...
                  <div class="col-md-4 mb-5 stretch-card transparent">
                    <div class="card bg-gradient-warning">
                      <div class="card-body">
                        <p class="mb-4 font-weight-bolder">Assigned Classes</p>
                        <p class="fs-30 mb-2"><?php echo $sc ?></p>
                      </div>
                    </div>
                  </div>
                  <div class="col-md-4 mb-5 stretch-card transparent">
                    <div class="card bg-gradient-success">
                      <div class="card-body">
                        <p class="mb-4 font-weight-bolder">Added Lesson Notes</p>
                        <p class="fs-30 mb-2"><?php echo $lsn ?></p>
                      </div>
                    </div>
                  </div>
                    ...
                    <div class="table-responsive">
                      <table class="table">
                        ...
                        <tbody>
                          ...
                          <?php
                          //search details from lesson notes table
                          $query_les = Database::search("SELECT * FROM `lesson_notes` WHERE `teachers_id` = '" . $_SESSION["t"]["id"] . "'");
