                ...
                <div class="main-panel w-100  documentation">
                    <div class="content-wrapper">
                        <div class="container-fluid">
                            ...
                            <div class="card-body">
                                <h4 class="card-title">View & Download Lesson Notes</h4>
                                <p class="card-description">
                                    Click download button to download your lesson notes
                                </p>
                                <div class="table-responsive">
                                    <table class="table text-center">
                                        ...
                                        <tbody>
                                            ...
                                            $query = Database::search("SELECT * FROM `lesson_notes` WHERE `grade_id` = '" . $_SESSION["s"]["grade_id"] . "'");
                                            $qnum = $query->num_rows;
                                            ...
                                            ?>
                                                <tr>
                                                    ...
                                                    <td><a class="btn btn-inverse-success" href="doc/lesson_notes/<?php echo $data["path"] ?>" download>Download</a></td>
