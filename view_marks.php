                ...
                <div class="main-panel w-100  documentation">
                    <div class="content-wrapper">
                        <div class="container-fluid">
                            ...
                            <div class="mb-4 mt-4">
                                <h4 class="font-weight-bold">View Assignment Marks</h4>
                                <h5>Pending results will be updated soon</h5>
                            </div>


                            <?php
                            //search details from uploaded assignment table without repeating
                                                ...
                                                <table class="table table-bordered text-center">
                                                    ...
                                                    <tbody>
                                                        ...
                                                        for ($i = 0; $i < $qnum; $i++) {
                                                            ...
                                                            $marks = Database::search("SELECT * FROM `student_results` WHERE `upload_assignment_id` = '" . $adata["id"] . "' AND `students_id` = '" . $adata["students_id"] . "' AND `grade_id` = '" . $data["grade_id"] . "' AND `subject_id` = '" . $data["subject_id"] . "' AND `officer_viewed_status_id` = '1'");
