            ...
            <div class="container-fluid">
              <div class="row">
                <div class="col-12 pt-5">
                  ...
                  <a class="btn btn-danger" href="assign_teachers_for_subjects.php"><i class="ti-shift-right mr-2"></i>Manage Subject Assigned Teachers</a>
                </div>
              </div>
              ...
              <div class="input-group col-5 mt-4">
                ...
                <div class="input-group-append" id="navbar-search-icon">
                  <button class="btn btn-sm btn-primary" onclick="teacher_search();">
              ...
              <div class="row pt-2 mt-2">
                <div class="col-md-12 grid-margin stretch-card">
                  <div class="card">
                    <div class="card-body">
                      <p class="card-title">Manage Teachers</p>
                      <div class="row">
                        <div class="col-12">
                          <div class="table-responsive">
                            <table id="example" class="display expandable-table" style="width: 100%">
                              <thead id="insidetable">
                                ...
                                <?php
                                //search all details from teachers table
                                $query = Database::search("SELECT * FROM `teachers`;");
                                ...
                                ?>
                                  <tr class="text-center">
                                    ...
                                    <td>
                                      ...
                                      ?>
                                        <label class="btn btn-inverse-success col-12" style="cursor: not-allowed;">Verified</label>
                                      <?php
                                      } else {
                                      ?>
                                        <label class="btn btn-inverse-primary col-12" style="cursor: not-allowed;">Not Verified</label>
                                      <?php
                                      }
                                      ?>
                                    </td>
