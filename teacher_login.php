        ...
        <div class="row w-100 mx-0">
          <div class="col-lg-4 mx-auto">
            <div class="auth-form-light text-left py-5 px-4 px-sm-5">
              ...
              <h4>Hello! Log into teacher's dashboard</h4>
              <h6 class="font-weight-light" id="errortext">Sign in to continue.</h6>
              <div class="pt-3">
                <div class="form-group">
                  <input type="text" class="form-control form-control-lg" id="teacherus" placeholder="Username" value="<?php echo $u; ?>" />
                </div>
                <div class="form-group">
                  <input type="password" class="form-control form-control-lg" id="teacherpw" placeholder="Password" value="<?php echo $p; ?>" />
                </div>
                <div class="mt-3">
                  <button onclick="teacher_login();" class="btn btn-block btn-primary btn-lg font-weight-medium auth-form-btn">SIGN IN</button>
                </div>
  ...
  <div class="modal fade" tabindex="-1" id="emailpopup">
    <div class="modal-dialog">
      <div class="modal-content">
        ...
        <div class="modal-footer">
          <button type="button" class="btn btn-secondary" data-dismiss="modal">Close</button>
          <button type="button" class="btn btn-primary" onclick="send_teacher_email();">Check Email</button>
        </div>
      </div>
    </div>
  </div>
  ...
  <div class="modal fade" tabindex="-1" id="forgetPasswordModal">
    <div class="modal-dialog">
      <div class="modal-content">
        ...
        <div class="modal-footer">
          <button type="button" class="btn btn-secondary" data-dismiss="modal">Close</button>
          <button type="button" class="btn btn-primary" onclick="reset_student_password();">Reset</button>
        </div>
      </div>
    </div>
  </div>
