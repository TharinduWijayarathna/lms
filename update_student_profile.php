                ...
                <div class="main-panel w-100  documentation">
                    <div class="content-wrapper">
                        <div class="container-fluid">
                            ...
                            $admin = Database::search("SELECT * FROM `students` WHERE `id` = '" . $_SESSION["s"]["id"] . "'");
                                    ...
                                    <div class="card-body">
                                        ...
                                        <div class="row">
                                            ...
                                            <div class="col-md-3">
                                                ...
                                                ?>
                                                    <img src="images/student_profile/<?php echo $idata["path"] ?>" id="imageload" width="100px" height="100px" style="border-radius: 50%;" alt="">
                                                <?php
                                                } else {
                                                ?>
                                        ...
                                        <div class="row">
                                            <div class="col-md-6">
                                                <div class="form-group row">
                                                    ...
                                                    <div class="col-sm-9">
                                                        <input type="text" class="form-control" disabled value="<?php echo $data["nic"] ?>" />
                                                    </div>
                                                </div>
                                            </div>
                                        ...
                                        <button class="btn btn-inverse-success col-4 offset-4" onclick="update_student();">Update</button>
