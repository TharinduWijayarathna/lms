                ...
                <div class="main-panel w-100  documentation">
                    <div class="content-wrapper">
                        <div class="container-fluid">
                            ...
                            <?php
                            //search details from admin table
                                ...
                                <div class="card">
                                    <div class="card-body">
                                        ...
                                        <div class="row">
                                            ...
                                            <div class="col-md-3">
                                                <?php
                                                //search details from admin img table
                                                ...
                                                ?>
                                                    <img src="images/admin_profiles/<?php echo $idata["path"] ?>" id="imageload" width="100px" height="100px" style="border-radius: 50%;" alt="">
                                                <?php
                                                } else {
                                                ?>
                                        ...
                                        <button class="btn btn-inverse-success col-4 offset-4" onclick="update_admin();">Update</button>
